...
namespace CryptoMarketData
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            using (var stream = Environment.ExpandEnvironmentVariables(File.ReadAllText(new FileInfo("log4net.config").FullName)).ToStream())
            {
            ...
            var processor = new MarketDataProcessor(settings);
            processor.Start();
